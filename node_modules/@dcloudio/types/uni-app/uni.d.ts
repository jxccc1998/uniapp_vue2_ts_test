declare namespace UniNamespace {
    ...
    interface GetStorageOptions {
         ...
         * 接口调用成功的回调函数
         */
        success?: (result: string | boolean | number | AnyObject) => void;
        /**
         * 接口调用失败的回调函数
         */
        fail?: (result: any) => void;
...
interface Uni {
     ...
     */
    setStorageSync(key: string, value: string | number | boolean | AnyObject): void;
    /**
     * 自定义统计上报数据
     *
     ...
     */
    onLocationChange(callback: (result: any) => void): any;
    /**
     ...
     */
    offLocationChange(callback: (result: any) => void): any;
    /**
     * 监听持续定位接口返回失败时触发。
     *
